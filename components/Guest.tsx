    ...
    <div className="font-sans bg-gray-100 text-gray-800">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between p-3 md:p-16 bg-gray-100 pt-20">
        ...
        <div className="flex-1 flex justify-center items-center">
          <Image
            ...
            alt="KeroSleepTracker Illustration"
      ...
      <div className="py-16 px-8 bg-white">
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          <div>
            <h3 className="text-xl font-bold">What is KeroSleepTracker?</h3>
            <p className="text-gray-600">
              KeroSleepTracker is a powerful tool designed to help you monitor your
          ...
          <div>
            ...
            <p className="text-gray-600">
              KeroSleepTracker analyzes your sleep data and provides personalized
              insights to help you achieve better sleep.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-bold">Is KeroSleepTracker free?</h3>
            <p className="text-gray-600">
              Yes, KeroSleepTracker offers a free plan with basic features. Premium
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-md shadow">
            <p className="text-gray-700 mb-4">
              &quot;KeroSleepTracker has completely transformed my sleep schedule. I
          ...
          <div className="bg-white p-6 rounded-md shadow">
            <p className="text-gray-700 mb-4">
              &quot;The insights from KeroSleepTracker have helped me identify and
          ...
          <div className="bg-white p-6 rounded-md shadow">
            <p className="text-gray-700 mb-4">
              &quot;KeroSleepTracker is so easy to use and provides accurate data.
